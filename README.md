...
- ✅ **Project versioning and stem archive** _(stub, awaits wire-up)_: Snapshots sessions, freezes tracks to stems, deduplicates audio assets, and stores reproducible render manifests for collaboration and recall.
...
- ✅ **Sourdough Schedule Builder** _(stub, awaits wire-up)_: Plans starter feedings, levain build, autolyse, bulk, and cold retard against ambient temperature and starter activity; estimates dough doubling time and final crumb hydration.
...
- ✅ **Project Costing and Stock Ledger** _(stub, awaits wire-up)_: Tracks raw stock (bar, sheet, wire, sprue, ingot, clay, glass rod, hide) with weight, dimensions, and per-unit cost; computes piece cost from kerf, scrap, fuel, electricity, and labor. Generates client quotes and bench-time invoices.
...
- ✅ **Rules Oracle** _(stub, awaits wire-up)_: Retrieval-augmented Q&A over loaded rulebooks, errata, and house rules with citation-anchored answers and a ruling-history log. Answers route through the active system profile so cross-edition rules do not leak into responses.
...
- ✅ **Terrarium climate logger** _(stub, awaits wire-up)_: Ingests temp, humidity, and UVB sensor streams (Solarmeter, BLE hygrometers, MQTT probes). Computes basking-to-cool-side gradient adherence, night drop compliance, and shed-cycle humidity bumps.

- ✅ **Pet training log** _(stub, awaits wire-up)_: Records sessions per cue with criteria, reinforcement schedule, latency, and success rate. Tracks shaping progress and proofs against distraction levels in a Karen Pryor / clicker style ladder.
...
- ✅ **Statcast pitch and shot renderer** _(stub, awaits wire-up)_: Plots pitch movement, release-point density, spin-axis tilt, and pitch-tunnel comparisons from Statcast or Trackman data; renders shot charts and expected-shooting heatmaps for basketball and hockey.
...
- ✅ **Pilot book ingestor** _(stub, awaits wire-up)_: Ingests cruising guides, harbour pilot pages, and notices to mariners as PDF, HTML, or scans, extracts anchorages, approaches, hazards, contacts, and VHF channels, and links each entry to a chart position. Cross-references with current NtMs to flag stale information.
